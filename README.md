...
- **Retention age** — report trace files older than this many days during **Verify all**. Blank means forever.
...
- **Retention age** defaults to blank, meaning keep forever.
- **Retention size** defaults to blank, meaning infinite.
